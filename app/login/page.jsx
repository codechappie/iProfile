...
const Login = () => {
  ...
  if (status === "loading") return <Spinner color="success" labelColor="success" />
      ...
      <div className={style.login}>
        ...
        <div className={`${style.bg_login} header finisher-header`} >
          ...
          <div className={style.loginContainer}>
            <h3>Iniciar sesión en iProfile</h3>

            <Divider className="my-4 mb-6 bg-zinc-200" />
            <div className={style.buttons}>
              <button className="flex items-center justify-center
             bg-white border border-gray-300 rounded-lg 
             shadow-md max-w-lg px-6 py-2 text-sm 
             font-medium text-gray-800 hover:bg-zinc-950/5 
            ...
            hover:bg-zinc-950/5	focus:outline-none 
